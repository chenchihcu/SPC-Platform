...
| Analytics/statistics/chart registry | `docs/governance/SPC_RULES.md`, `.Codex/skills/analytics-engine-contract/SKILL.md` | `spc-stat-contract-reviewer` | focused pytest, then `python .Codex/skills/spc-validation-matrix/scripts/run_matrix.py --quick` when routing changes |
...
| Docs/harness/Codex automation | `AGENTS.md`, `AGENTS.md`, `docs/harness/README.md` | none by default | `pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/harness_check.ps1` |
